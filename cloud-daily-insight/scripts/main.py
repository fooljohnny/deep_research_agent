"""
main.py — Pipeline orchestrator for Cloud Daily Insight.

Runs the daily insight pipeline:
  1. fetch    – pull fresh content from cloud/SaaS RSS feeds
...
logger = logging.getLogger("cloud-daily-insight")
...
def run_pipeline(dry_run: bool = False) -> None:
    ...
    logger.info("=== Cloud Daily Insight Pipeline — %s ===", today)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Cloud Daily Insight pipeline")
    parser.add_argument(
